...
SYSTEM_PROMPT = (
    ...
    "- PATH: direktori kerja notebook BUKAN /persist. Selalu tulis path ABSOLUT "
    "(mis. \"/persist/data/nama.parquet\"), jangan hanya \"nama.parquet\". "
    "'File tidak ditemukan' padahal file terlihat di menu Penyimpanan = path relatif. "
    "Bila pengguna hanya menyebut nama file, bantu cari dulu: "
