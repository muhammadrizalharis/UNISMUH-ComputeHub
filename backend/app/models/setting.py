...
class SystemSetting(Base):
    ...
    student_max_storage_mb: Mapped[float] = mapped_column(Float, default=0.0)
    ...
    dosen_max_storage_mb: Mapped[float] = mapped_column(Float, default=0.0)
    ...
    admin_max_storage_mb: Mapped[float] = mapped_column(Float, default=0.0)
