...
class Settings(BaseSettings):
    ...
    STUDENT_MAX_RAM_MB: float = 4096.0      # plafon RAM proses (MB); 0 = tanpa batas
    ...
    DOSEN_MAX_RAM_MB: float = 4096.0                 # plafon RAM proses (MB); 0 = tanpa batas
